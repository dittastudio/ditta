...
const info = computed(() => ({
  ...
  312: { icon: WeatherDrizzle, description: `Heavy drizzle` },
  313: { icon: WeatherDrizzle, description: `Shower rain and drizzle` },
  314: { icon: WeatherDrizzle, description: `Heavy showers and drizzle` },
  ...
  502: { icon: WeatherRainHeavy, description: `Heavy rain. Classic London!` },
