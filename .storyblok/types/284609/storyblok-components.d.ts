...
import type { StoryblokMultilink, StoryblokAsset, StoryblokRichtext, StoryblokMultiasset } from '../storyblok.d.ts';
export interface BlockClients {
  heading?: string;
