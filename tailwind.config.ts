      ...
      typography: ({ theme }: { theme: any }) => ({
        ...
        ditta: {
          css: {
            ...
            '--tw-prose-headings': theme('colors.offblack'),
            '--tw-prose-lead': theme('colors.offblack'),
            '--tw-prose-links': theme('colors.offblack'),
            '--tw-prose-bold': theme('colors.offblack'),
            '--tw-prose-counters': theme('colors.offblack'),
            '--tw-prose-bullets': theme('colors.offblack'),
            '--tw-prose-hr': theme('colors.offblack'),
            '--tw-prose-quotes': theme('colors.offblack'),
            '--tw-prose-quote-borders': theme('colors.offblack'),
            '--tw-prose-captions': theme('colors.offblack'),
            '--tw-prose-code': theme('colors.offblack'),
            '--tw-prose-pre-code': theme('colors.white'),
            '--tw-prose-pre-bg': theme('colors.offblack'),
            '--tw-prose-th-borders': theme('colors.offblack'),
            '--tw-prose-td-borders': theme('colors.offblack'),
            ...
            '--tw-prose-invert-pre-code': theme('colors.offblack'),
